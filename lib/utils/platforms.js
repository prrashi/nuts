...
function detectPlatform(platform) {
    ...
    if (_.includes(name, 'linux')
        ...
        else if (_.includes(name, 'linux') || hasSuffix(name, '.tgz') || hasSuffix(name, '.tar.gz')) {
    ...
    var hasAmd64 = _.includes(name, 'amd64');
    var hasX64 = _.includes(name, 'x64');

    if (_.includes(name, '64') || hasX64 || hasAmd64) suffix = '64';
