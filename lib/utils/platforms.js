...
function detectPlatform(platform) {
    ...
    var hasAmd64 = _.contains(name, 'amd64');
    var hasX64 = _.contains(name, 'x64');

    if (_.contains(name, '64') || hasX64 || hasAmd64) suffix = '64';

    if (prefix === platforms.OSX) {

      if (hasAmd64) suffix = 'amd' + suffix
      else if (hasX64) suffix = 'x' + suffix
    }
